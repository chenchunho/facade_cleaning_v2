...
// 本檔與 `transport/Serial_port.h` 是**兩個不同的實作**，卻共用同一個 include
// guard `SERIAL_PORT_H`：
//   - 本檔（322 行）：cleaning_arm 的 damiao 那一套，經 user_lib/damiao.h 引入
//   - transport/Serial_port.h：本專案的序列埠，被 WASH_ROBOT.h / WT901BC_TTL.h /
//     Linux_test 使用
