...
| **09-04** | 🔴 **待重新決定** | ~~12 = 8N1 RTU —— 配合與 SD76 共用同一條 bus 的 8N1~~ **[2026-09-09] 這個理由已過期**：SD76 在 2026-05-15 re-layout 已移到 `.34`，MH300 要接的 `.30`/`.31` 上沒有 SD76；實查兩台網關**現在是 8N2**。⇒ **照舊填 8N1 會與網關不符、整段不通**。應改為 MH300 的 8N2 代碼（查手冊 09-04 對照表確認）。|
| **00-20** | **1** | 頻率來源 = RS-485 |
| **00-21** | **2** | 運轉來源 = RS-485 |
