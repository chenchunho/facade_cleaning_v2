...
| 檔案 | 原值 | 測試模式值 | 還原 |
|---|---|---|---|
| `user_lib/WASH_ROBOT.h:100` `CRANE_IP` | `"192.168.1.101"` | `"192.168.5.26"` | **改回 `"192.168.1.101"`** |
| `user_lib/WASH_ROBOT.h:147` `WATCHDOG_TIMEOUT_MS` | `2000` | `60000` | **改回 2000** |
| `user_lib/WASH_ROBOT.cpp:61,69,77,84` driver init `debug` | `false` | `true` | **改回 false** |
| `user_lib/WASH_ROBOT.cpp:99` IMU init `debug` | `false` | `true` | **改回 false** |
